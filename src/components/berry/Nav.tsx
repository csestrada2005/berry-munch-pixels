  ...
  return (
    <nav className="absolute left-1/2 top-6 z-30 -translate-x-1/2 px-4 w-full max-w-3xl">
      ...
      <div className="flex items-stretch h-12 md:h-14 drop-shadow-xl">
        <RibbonEnd />
        <div className="flex-1 flex items-center justify-between bg-berry border-y-2 border-cream/30 px-6 md:px-10">
          <span className="font-display text-base md:text-lg font-bold text-cream tracking-wider md:hidden">
            BERRY MUNCH
          </span>
            ...
            {links.map((l) => (
              <li key={l.href}>
                <a
                  ...
                  className="font-display text-sm lg:text-base font-bold text-cream tracking-[0.2em] transition-colors hover:text-gold"
                >
                  {l.label}
                </a>
              </li>
      ...
      {open && (
        <div className="md:hidden mt-2 rounded-lg bg-berry p-4 shadow-lg border-2 border-cream/30">
            ...
            {links.map((l) => (
              <li key={l.href}>
                <a
                  href={l.href}
                  onClick={(e) => handleNavClick(e, l.href)}
                  className="block font-display text-sm font-bold text-cream tracking-[0.2em]"
                >
                  {l.label}
                </a>
              </li>
