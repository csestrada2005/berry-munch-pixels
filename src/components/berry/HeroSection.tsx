...
export function HeroSection() {
  return (
    <section className="relative min-h-[480px] md:min-h-[540px] lg:min-h-[600px] overflow-hidden bg-white pt-16 pb-12">
      {/* Background video */}
      <video
        src={heroVideo}
        autoPlay
      ...
      <div className="relative z-40 mx-auto max-w-7xl px-6 md:px-10 -mt-4">
